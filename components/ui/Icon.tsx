...
export const IconWand: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}><path d="M15 4V2"/><path d="M15 16v-2"/><path d="M8 9h2"/><path d="M20 9h2"/><path d="M17.8 11.8 19 13"/><path d="m15 9-1-1"/><path d="M11.8 17.8 13 19"/><path d="M9 15l-1-1"/><path d="M4.2 7.2 3 6"/><path d="M7.2 4.2 6 3"/><path d="m19 6-1.2-1.2"/><path d="M6 19l-1.2-1.2"/><path d="m12 12 4 4"/><path d="M12 2v10h10v-2L12 2Z"/></svg>
);
